...
def main():
    # 데이터를 불러옵니다.
    x_train, y_train, x_val, y_val = preprocess.load_data(r'C:\lsc\ML-practice-1\ML2\sol_q3\iris.csv', independent_var = ['petal length', 'sepal length'], response_var = 'class_num' )
